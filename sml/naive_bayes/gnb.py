...
class GaussianNB:
    ...
    def tree_unflatten(cls, static_data, dynamic_data):
        ...
        ins = cls(classes_=classes, var_smoothing=var_smoothing)
        ins.first_ = first
        ins.n_sample = n_sample
        ins.n_features = n_features
        ins.theta_ = theta
        ins.var_ = var
        ins.class_count_ = class_count
        ins.total_count_ = total_count
        ins.class_prior_ = class_prior
        ins.epsilon_ = epsilon
        return ins

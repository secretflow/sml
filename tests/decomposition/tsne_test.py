...
def test_tsne_similarity_init_pca():
    ...
    assert Y_sklearn.shape == Y_spu.shape
    ...
    try:
        trust_spu = trustworthiness(X, Y_spu, n_neighbors=n_neighbors_trustworthiness)
...
def test_tsne_similarity_init_random():
